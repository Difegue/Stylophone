...
namespace FluentMPC.Views
{
    ...
    {
        public PlaybackViewModel PlaybackViewModel { get; } = new PlaybackViewModel(CoreWindow.GetForCurrentThread().Dispatcher);
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            MPDConnectionService.ConnectionLost += MPDConnectionService_ConnectionLost;
        }
